...
def train_one_epoch(model, dataloader, optimizer,
    ...
    for source_mel, target_mel, target_speaker_id in tqdm(dataloader):
        ...
        mel_pred_post, mel_pred,content_emb, spk_logits, src_spk_emb, trg_spk_emb = model(source_mel, target_mel)  # (B, T, 80)
...
def train(model, dataloader,
    ...
    if os.path.exists(history_path):
        ...
        history = {"recon": [], "speaker_ce": [], "speaker_cos": [], "speaker_total": []}
